...
public interface CoinbaseExchange {
    ...
    <T> T pagedGet(String endpoint, ParameterizedTypeReference<T> responseType, String beforeOrAfter, Long pageNumber, Integer limit);
    <T> List<T> getAsList(String endpoint, ParameterizedTypeReference<T[]> type);
    <T> List<T> pagedGetAsList(String endpoint, ParameterizedTypeReference<T[]> responseType, String beforeOrAfter, Long pageNumber, Integer limit);
